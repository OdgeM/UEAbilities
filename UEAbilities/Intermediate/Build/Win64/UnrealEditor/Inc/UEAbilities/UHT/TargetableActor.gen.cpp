...
void Z_Construct_UClass_ATargetableActor_Statics::NewProp_bIsTargeted_SetBit(void* Obj)
{
	((ATargetableActor*)Obj)->bIsTargeted = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATargetableActor_Statics::NewProp_bIsTargeted = { "bIsTargeted", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ATargetableActor), &Z_Construct_UClass_ATargetableActor_Statics::NewProp_bIsTargeted_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsTargeted_MetaData), NewProp_bIsTargeted_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATargetableActor_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATargetableActor_Statics::NewProp_bIsTargeted,
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ATargetableActor_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UTargetable_NoRegister, (int32)VTABLE_OFFSET(ATargetableActor, ITargetable), false },  // 4229720885
};
...
struct Z_CompiledInDeferFile_FID_Users_ojmar_OneDrive_Documents_GitHub_UEAbilities_UEAbilities_Source_UEAbilities_Public_TargetableActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATargetableActor, ATargetableActor::StaticClass, TEXT("ATargetableActor"), &Z_Registration_Info_UClass_ATargetableActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATargetableActor), 1105812612U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ojmar_OneDrive_Documents_GitHub_UEAbilities_UEAbilities_Source_UEAbilities_Public_TargetableActor_h_1618365110(TEXT("/Script/UEAbilities"),
